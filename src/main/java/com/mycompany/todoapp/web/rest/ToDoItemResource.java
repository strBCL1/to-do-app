...
public class ToDoItemResource {
    ...
    @PutMapping("/users/current-user/to-do-items/{to-do-item-id}")
    @Secured({ AuthoritiesConstants.USER })
    public ResponseEntity<ToDoItemDTO> updateToDoItemOfCurrentUser(
        @Valid @RequestBody ToDoItemModificationDTO toDoItem,
